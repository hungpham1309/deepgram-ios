...
class ViewController: UIViewController {
    ...
    private let apiKey = "Token 8c699ed5932bed9e02500b8c87aba326230f5e15"
...
//        let url = URL(string: "wss://api.deepgram.com/v1/listen?encoding=linear16&sample_rate=48000&channels=1&model=nova&smart_format=true&filler_words=true")!
        let url = URL(string: "wss://bd1b-18-139-19-14.ngrok-free.app/v1/listen")!
...
extension ViewController: WebSocketDelegate {
    func didReceive(event: WebSocketEvent, client: WebSocket) {
        ...
        case .text(let text):
            ...
            let transcript = response.channel.transcript
